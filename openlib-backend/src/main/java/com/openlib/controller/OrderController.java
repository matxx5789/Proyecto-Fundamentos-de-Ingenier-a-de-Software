...
public class OrderController {
    ...
    @Operation(summary = "Cambiar estado de la orden (buyer)")
    public OrderResponse changeStatus(@AuthenticationPrincipal User user,
                                      @PathVariable Long id,
                                      @PathVariable String newStatus) {
        return orderService.changeOrderStatus(id, user.getId(), newStatus);
    }
}
